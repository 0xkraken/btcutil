...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/0xkraken/btcutil/coinset)
...
```bash
$ go get -u github.com/0xkraken/btcutil/coinset
```
